...
class richconsulting_theme_hooks {
    ...
    function __construct() {
        ...
        add_action('wp_enqueue_scripts',array(&$this,'richconsulting_bar_plugin_scripts'));

        add_action('richconsulting_single_navigation',array(&$this,'single_nav'));
        add_action('richconsulting_pagination',array(&$this,'richconsulting_posts_pagination'));
        add_action('richconsulting_related_post',array(&$this,'richconsulting_related_post'));
        add_action('richconsulting_authorbox',array(&$this,'richconsulting_authorbox'));
        add_action('richconsulting_share_tags',array(&$this,'richconsulting_share_tag'));
 
        add_action('richconsulting_header',array(&$this,'richconsulting_render_header'));
        add_action('richconsulting_footer',array(&$this,'richconsulting_render_footer'));
        add_action('richconsulting_sidebar',array(&$this,'richconsulting_render_sidebar'));
    ...
    function richconsulting_render_sidebar(){
    ...
    function richconsulting_render_footer(){
    ...
    function richconsulting_render_header(){
    ...
    function richconsulting_share_tag(){
    ...
    ?>    
        ...
        <div class="share_tag"> 
            <div class="richconsulting_tag float-left text-left ul-li">
                <?php echo richconsulting_html($out);?>
            </div>
            <div class="share_post float-right text-right ul-li">
                <h3><?php echo richconsulting_html($tagtitle);?></h3>
    ...
    ?>
        ...
        <div class="postby_author">
            <div class="author_img">
                <?php echo richconsulting_html($img);?>
            </div>
            <span><?php echo richconsulting_html($title);?></span>
    ...
    ?>
        ...
        <div class="related_postview">
            <h3><?php echo richconsulting_html($title);?></h3>
            <?php
    ...
    function richconsulting_posts_pagination(){
        ...
        <div class="next_prev_post relative-position  clearfix">
            ...
            <?php if(!empty($pid)){ ?>
                <div class="nio_prev_post text-left float-left headline">
                        <a href="<?php echo richconsulting_html($plink);?>">
    ...
    function richconsulting_bar_plugin_scripts() {
...
new richconsulting_theme_hooks();
